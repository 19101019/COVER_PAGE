...
.body.words span:nth-child(2) {
  -webkit-animation-delay: 0.5s;
          animation-delay: 0.5s;
}

.body.words span:nth-child(3) {
  -webkit-animation-delay: 1.0s;
          animation-delay: 1.0s;
}

.body.words span:nth-child(4) {
...
@keyframes move {
  ...
  50% {
    text-shadow: 0 5px 30px rgba(0, 0, 0, 0.781);
  }
  100% {
    -webkit-transform: translate(33%, 0);
            transform: translate(33%, 0);
...
#section08 a span::before {
 ...
 .button {
  ...
  border-radius: 40px;
  -webkit-box-shadow: -6px -20px 35px #ffffff, -6px -10px 15px #ffffff, -20px 0px 30px #ffffff, 6px 20px 25px rgba(0, 0, 0, 0.2);
...
.button__content {
  ...
  -webkit-box-shadow: inset 0px -8px 0px #dddddd, 0px -8px 0px #f4f5f6;
...
.btn:active .btn__content .btn__text, .btn:active .btn__content .btn__icon {
  -webkit-transform: translate3d(0px, 0px, 0px);
          transform: translate3d(0px, 0px, 0px);
}
...
<body>
    <section id="section07" class="demo">
        <div class="aww" style="height: 40vh;">
            <canvas id="canvas" style="position:absolute; top:0; left:0;"></canvas>
            <div id="buffer" style="display:none;"></div>  </div>
             <a href="#section08">
           <span></span><span></span><span></span></a>
      </section>
      <section id="section08" class="demo">
        
        <div class="body"> <a href="https://freefrontend.com/css-buttons/">
            <button class="button" >
                <div class="button__content">
                  ...
                  <p class="button__text">WELCOME</p>
                </div>
              </button></a>
  ...
  <span>'S</span>
      ...
      <img src="j.png" style="margin-left:28px;margin-top: 0px;"> 
      <a href="https://freefrontend.com/css-buttons/"></a>
      <button class="btn" >
        <div class=btn__content">
            ...
            <p class="button__text">EXIT</p>
          </div>

      </button> </a>

      <footer style="margin: 0;padding: 0;
     background-color: rgb(31, 30, 30);height: 15%;
      ">
      <p style="margin: 5% 40%; color: cornsilk;">
         <br>    Copyright &COPY2019<br>Designed and build by Swati Mandal
      </p></footer>
      <script>
          $(function() {
    ...
    $('html, body').animate({ scrollTop: $($(this).attr('href')).offset().top}, 500, 'linear');
       ...
       <script>
        ...
        var textSet = [{
            ...
            text: "@@@@@@@@",
            sphereRadius: 80 + Math.random() * 60,
            sphereSpace: 200,
            unitTime: 100,
            time: 4000
        },{
